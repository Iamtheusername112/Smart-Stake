    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.success('Welcome to SmartStake Casino! 🎰', {
          description: `Your ${leadData.bonusAmount} casino bonus is ready! Check your email for details.`,
          duration: 5000,
        });
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
        <Card className="w-full max-w-lg text-center shadow-2xl border-0 bg-white/95 backdrop-blur-sm">
          <CardContent className="p-12">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Welcome to SmartStake Casino! 🎰</h2>
            <p className="text-gray-600 mb-8 text-lg">
              Your VIP casino account has been created successfully! Check your email for your exclusive bonus details.
            </p>
            <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-6 mb-8">
              <h3 className="font-bold text-gray-900 mb-4 text-lg">Your Casino Bonus:</h3>
              <div className="space-y-3 text-left">
                ...
                <div className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
                  <span className="text-gray-700">Access to 500+ casino games</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3" />
        ...
        <div className="relative z-10 container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-white text-sm font-medium">#1 Online Casino 2025</span>
            </div>
            ...
            <p className="text-xl text-white/80 mb-10 max-w-3xl mx-auto leading-relaxed">
              Play 500+ premium casino games with the highest RTP rates. Get instant bonuses, 
              live dealer games, and VIP treatment at SmartStake Casino.
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-20">
            <div className="text-center">
              ...
              <div className="text-white/60">Casino Games</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-white mb-2">98%</div>
              <div className="text-white/60">Average RTP</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-white mb-2">24/7</div>
              <div className="text-white/60">Live Dealers</div>
            </div>
            <div className="text-center">
          ...
          {/* Game Categories */}
          <div className="mb-20">
            <h2 className="text-4xl font-bold text-white text-center mb-4">Premium Casino Games</h2>
            <p className="text-white/60 text-center mb-16 text-lg">The best casino games with highest payouts</p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="bg-white/10 backdrop-blur-sm border-white/20 hover:bg-white/15 transition-all duration-300 group">
                <CardContent className="p-8 text-center">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-4">Slots</h3>
                  <p className="text-white/70 text-lg leading-relaxed">200+ premium slot games with progressive jackpots up to $10M</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20 hover:bg-white/15 transition-all duration-300 group">
                <CardContent className="p-8 text-center">
                  <div className="w-16 h-16 bg-gradient-to-r from-green-400 to-emerald-500 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                    <Dice2 className="w-8 h-8 text-white" />
                  </div>
                  <h3 className="text-2xl font-bold text-white mb-4">Live Casino</h3>
                  <p className="text-white/70 text-lg leading-relaxed">Professional dealers, HD streaming, and real-time interaction</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20 hover:bg-white/15 transition-all duration-300 group">
                <CardContent className="p-8 text-center">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-4">Table Games</h3>
                  <p className="text-white/70 text-lg leading-relaxed">Blackjack, Roulette, Baccarat with multiple variants</p>
                </CardContent>
              </Card>
            </div>
          </div>
          ...
          {/* Casino Features */}
          <div className="mb-20">
            <h2 className="text-4xl font-bold text-white text-center mb-4">Why Choose SmartStake Casino?</h2>
            <p className="text-white/60 text-center mb-16 text-lg">The ultimate casino experience with unmatched benefits</p>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white mb-2">Highest RTP Games</h3>
                    <p className="text-white/70">Our games have the highest Return to Player rates in the industry, up to 98%</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">Get your winnings instantly with our lightning-fast withdrawal system</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">Personal account managers, exclusive games, and premium bonuses</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">256-bit SSL encryption and licensed by top gaming authorities</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">Round-the-clock customer support via chat, email, and phone</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">Get daily bonuses, free spins, and exclusive promotions</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Social Proof */}
          <div className="mb-20">
            <h2 className="text-4xl font-bold text-white text-center mb-4">What Our Casino Players Say</h2>
            <p className="text-white/60 text-center mb-16 text-lg">Join thousands of satisfied casino players</p>
                ...
                <CardContent className="p-8">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      ...
                      <div className="text-white/60">Casino VIP</div>
                      <div className="flex">
                        {[...Array(5)].map((_, i) => (
                  ...
                  <p className="text-white/80 text-lg leading-relaxed">"I've won over $25,000 playing slots here! The RTP rates are incredible and payouts are instant."</p>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-8">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      ...
                      <div className="text-white/60">Live Casino Player</div>
                      <div className="flex">
                        {[...Array(5)].map((_, i) => (
                          <Star key={i} className="w-4 h-4 text-yellow-400 fill-current" />
                        ))}
                  ...
                  <p className="text-white/80 text-lg leading-relaxed">"The live dealers are amazing! It feels like being in a real casino. I love the VIP treatment!"</p>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-8">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      ...
                      <div className="text-white/60">Table Games Expert</div>
                      <div className="flex">
                        {[...Array(5)].map((_, i) => (
                          <Star key={i} className="w-4 h-4 text-yellow-400 fill-current" />
                        ))}
                  ...
                  <p className="text-white/80 text-lg leading-relaxed">"Best blackjack tables online! The dealers are professional and the game variety is unmatched."</p>
                </CardContent>
              </Card>
            </div>
          </div>
            ...
            <Card className="bg-gradient-to-r from-red-500 via-pink-500 to-purple-600 border-0 max-w-4xl mx-auto shadow-2xl">
              <CardContent className="p-12">
                <div className="flex items-center justify-center mb-6">
                  ...
                  <span className="text-white text-xl font-bold">LIMITED TIME CASINO OFFER</span>
                </div>
                <h2 className="text-4xl font-bold text-white mb-6">Don't Miss Out!</h2>
                <p className="text-white text-xl mb-8 leading-relaxed">
                  Join now and get a $300 casino bonus + 100 free spins + VIP status. 
      ...
      <footer className="border-t border-white/20 py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-white/10 mt-8 pt-8 text-center text-white/40">
            <p>&copy; 2025 SmartStake Casino. All rights reserved. | Licensed & Regulated</p>
          </div>
        </div>
      </footer>
